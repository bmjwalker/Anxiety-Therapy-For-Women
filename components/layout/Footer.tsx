        ...
        <div className="mt-12 pt-6 border-t border-cream/10 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-center sm:justify-end gap-5">
            ...
            <a href="https://www.youtube.com/@HighPerformingWomen" target="_blank" rel="noopener noreferrer" className="opacity-60 hover:opacity-100 transition-opacity duration-200 text-white">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.97C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 0 0-1.95 1.96C1 8.12 1 12 1 12s0 3.88.46 5.58a2.78 2.78 0 0 0 1.95 1.97C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.95-1.97C23 15.88 23 12 23 12s0-3.88-.46-5.58z"/>
            ...
            <a href="https://www.psychologytoday.com/profile/289498" className="sx-verified-seal opacity-60 hover:opacity-100 transition-opacity duration-200" />
          </div>
          <Script
            src="https://member.psychologytoday.com/verified-seal.js"
            data-badge="13"
            data-id="289498"
            data-code="aHR0cHM6Ly93d3cucHN5Y2hvbG9neXRvZGF5LmNvbS9hcGkvdmVyaWZpZWQtc2VhbC9zZWFscy8xMy9wcm9maWxlLzI4OTQ5OD9jYWxsYmFjaz1zeGNhbGxiYWNr"
            strategy="lazyOnload"
          />
