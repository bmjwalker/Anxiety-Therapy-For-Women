...
export const metadata: Metadata = {
  title: {
    absolute: "Disclaimer | Jennifer Walker, LCSW",
  },
  description:
...
const sections: Section[] = [
  {
    paragraphs: [
      "The website is owned by Jennifer Walker and J&K Walker, LLC DBA Jennifer Walker, LCSW.",
  ...
  {
    heading: "Indemnification and Release of Claims",
    paragraphs: [
          ...
          <div className="section-container max-w-3xl mx-auto">
            ...
            <div className="flex flex-col gap-8">
              {sections.map((section, i) => (
                <div key={section.heading ?? `intro-${i}`} className="flex flex-col gap-5">
                  {section.heading && (
                    <h2
              ...
              <div className="flex flex-col gap-5">
                ...
                <p className="text-base leading-relaxed" style={{ color: "#57686B" }}>
                  By using my Website you are agreeing to all parts of the above Disclaimer. If
                  you have any questions about this Disclaimer, please contact me at{" "}
                  <a
                    href="mailto:jenniferwalkerlcsw@gmail.com"
                    className="underline hover:opacity-80 transition-opacity"
                    style={{ color: "#CAAF99" }}
                  >
                    jenniferwalkerlcsw@gmail.com
                  </a>
                  .
                </p>
              </div>
